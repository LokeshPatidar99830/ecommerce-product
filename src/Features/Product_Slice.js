...
export const productslice = createSlice({
   ...
   reducers:{
    ...
    //     const removeitem =state.cartvalue.find(item=>item.id === action.payload.id);
    //     if(removeitem){
...
export const {addtocart,removecart,incementquantity,decrementquantity,clearAll}=productslice.actions;
